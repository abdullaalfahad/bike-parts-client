...
const Contact = () => {
    ...
    return (
        <div className='w-11/12 lg:w-11/12 mx-auto pb-12 md:pb-28 text-primary'>
            <h1 className='text-xl lg:text-4xl font-bold text-center mb-6 lg:mb-14'>Our <span className='text-secondary'>Professionals</span></h1>
